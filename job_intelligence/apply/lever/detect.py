#!/usr/bin/env python3
"""Lever handler. Routes to common fill → submit.
Lever: single-page form, no multi-step.
"""
...
print(f"PLATFORM: lever", file=sys.stderr)
...
if check_page(text, "lever", ALREADY_APPLIED):
...
state = {"jid": jid, "url": url, "type": "lever", "platform": "lever",
